...
def plot_adjusted_peaks(x_fit,y_fit,peaks,yout,r_p,lb,hb):
...
if len(files)>0:
    ...
    for x_fit,y_fit,peaks,yout,r_p in zip(x_fitL, y_fitL, peaksL, youtL,r_pL):
        plot_adjusted_peaks(x_fit,y_fit,peaks,yout,r_p,lb,hb)
